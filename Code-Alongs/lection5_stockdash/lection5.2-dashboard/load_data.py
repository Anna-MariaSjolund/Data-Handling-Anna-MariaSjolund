...
df = pd.read_csv("Code-Alongs/lection5_stockdash/data/AAPL_TIME_SERIES_DAILY.csv")
print(df.head())

class StockDataLocal:
    """Class method to get and process local stock data"""
    
    def __init__(self, data_folder_path:str="Code-Alongs/lection5_stockdash/data/") -> None:
